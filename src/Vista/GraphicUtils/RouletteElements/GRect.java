...
public class GRect {
    ...
    public void render(Graphics g, int rx, int ry) {
        final int[] x = {(int) x1 - 300 + rx/2, (int) x2 - 300 + rx/2, (int) x4 - 300 + rx/2, (int) x3 - 300 + rx/2};
        final int[] y = {(int) y1 - 300 + ry/2, (int) y2 - 300 + ry/2, (int) y4 - 300 + ry/2, (int) y3 - 300 + ry/2};
